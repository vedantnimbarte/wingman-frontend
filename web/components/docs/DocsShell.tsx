  ...
  return (
    <div className="border-t border-hairline/50">
      <div className="mx-auto flex w-full max-w-content">
        {/* Desktop sidebar */}
        <aside className="sticky top-14 hidden h-[calc(100vh-3.5rem)] w-64 shrink-0 overflow-y-auto border-r border-hairline/50 px-5 py-8 lg:block">
        ...
        <div className="min-w-0 flex-1">
          {/* Mobile bar */}
          <div className="sticky top-14 z-30 flex items-center gap-3 border-b border-hairline/50 bg-canvas/90 px-6 py-3 backdrop-blur lg:hidden">
            <button
              type="button"
              onClick={() => setDrawer(true)}
              className="rounded-md border border-hairline bg-surface-1 px-3 py-2 text-body-sm text-ink"
